...
import nuxt_plugin_plugin_ab3258ce from 'nuxt_plugin_plugin_ab3258ce' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_moment_8a47d848 from 'nuxt_plugin_moment_8a47d848' // Source: .\\moment.js (mode: 'all')
import nuxt_plugin_axios_1e54253c from 'nuxt_plugin_axios_1e54253c' // Source: .\\axios.js (mode: 'all')
import nuxt_plugin_templatesplugindc4e387a_650976e6 from 'nuxt_plugin_templatesplugindc4e387a_650976e6' // Source: .\\templates.plugin.dc4e387a.js (mode: 'all')
...
import nuxt_plugin_plugin_690a37eb from 'nuxt_plugin_plugin_690a37eb' // Source: .\\auth\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_ab3258ce === 'function') {
    await nuxt_plugin_plugin_ab3258ce(app.context, inject)
  }

  if (typeof nuxt_plugin_moment_8a47d848 === 'function') {
    await nuxt_plugin_moment_8a47d848(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_1e54253c === 'function') {
    await nuxt_plugin_axios_1e54253c(app.context, inject)
  }

  if (typeof nuxt_plugin_templatesplugindc4e387a_650976e6 === 'function') {
    await nuxt_plugin_templatesplugindc4e387a_650976e6(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_plugin_690a37eb === 'function') {
    await nuxt_plugin_plugin_690a37eb(app.context, inject)
  }
