            ...
            <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
              <li class="nav-item dropdown">
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="media-body  ml-2  d-none d-lg-block">
                      <span class="mb-0 text-sm  font-weight-bold"> guest <i style="margin-left: 5px"
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <!-- </router-link> -->
                  <router-link to="/login" class="dropdown-item text-primary" @click="logout()" style="cursor:pointer">
...
<script>
  import Sidebar from '../components/SidebarCostumer';
  import { mapMutations, mapGetters } from "vuex";
  import { config } from "../global.config";
  export default {
    // middleware: ['auth', 'costumer'],
    // components: {
    //   'sidebar': Sidebar
    // },
    data() {
